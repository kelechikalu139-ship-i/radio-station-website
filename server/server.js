...
app.get("/api/radio-proxy", async (req, res) => {
  ...
  if (type === "stream") {
    try {
      // CORRECTED: Using port 8440 from your dashboard
      const possibleUrls = [
        // Your actual MP3 stream on port 8440 (from dashboard)
        "https://radio.sternhost.com:8440/radio.mp3",
        "https://radio.sternhost.com:8440/stream",
        
        // Using IP directly (sometimes more reliable)
        "https://54.38.62.187:8440/radio.mp3",
        
        // HLS option from your dashboard
        "https://radio.sternhost.com/hls/station_1149_1773756634/live.m3u8",
        
        // SHOUTcast-style URLs
        "https://radio.sternhost.com:8440/;stream.nsv",
        "https://radio.sternhost.com:8440/;",
        
        // Fallbacks (keeping original as last resort)
        "https://radio.sternhost.com/radio.mp3",
        "https://radio.sternhost.com:8000/radio.mp3",
      ];
      ...
      res.status(502).json({ 
        error: 'Stream unavailable',
        details: error.message,
        suggestion: "Please check if your Sternhost stream is active on port 8440"
      });
    }
  } 
