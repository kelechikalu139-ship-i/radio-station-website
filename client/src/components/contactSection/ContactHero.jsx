          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight">
                Nexter FM — <span className="text-yellow-300">Talk to Us</span>
              </h1>
              ...
              <div className="mt-6">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-xl shadow hover:scale-[1.02] transition"
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl overflow-hidden shadow-2xl ring-1 ring-black/30 bg-linear-to-b from-purple-700 to-purple-800 p-6">
                ...
                <div className="mt-6 bg-white/6 border border-white/8 rounded-xl p-4">
                  ...
                  <div className="mt-1 font-semibold text-white">Plot 12 Radio Avenue, Minna</div>
                  <div className="text-sm text-white/70 mt-1">Phone: +234 800 000 0000</div>
                </div>
              </div>
            </div>
          </div>
