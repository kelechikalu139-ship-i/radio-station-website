...
//     try {
//       const res = await api.get("/api/featured/features");
//       setFeatured(res.data.features || []);
//     } catch (err) {
...
// export default function FeaturedNews() {
//   const [featured, setFeatured] = useState(null); // null = not loaded, object = loaded
//   const [loading, setLoading] = useState(true);
...
//         // We usually want only the first (most recent) featured item
...
//   if (error || !featured) {
//     // You can show nothing, or a fallback message / different UI
//     return null; // ← most common for featured sections (silent fail)
//     // Alternative:
//     // return <div className="text-gray-400">No featured news available</div>;
//   }

//   return (
//     <section className="container mx-auto px-5 py-14">
//       <div className="grid md:grid-cols-2 gap-8 items-center">
//         {/* Image — prefer cloudinary URL from DB */}
//         <img
//           src={featured.image_url || "/images/news/news1.jpeg"} // fallback if no image
//           className="rounded-xl shadow-lg object-cover h-72 w-full"
...
//             {featured.content?.replace(/<[^>]+>/g, "") || ""} {/* strip HTML if needed */}
//           </p>

//           <Link
//             to={`/news/${featured.id}`}           // adjust path to match your routing
//             className="mt-5 inline-block bg-purple-700 text-white px-6 py-3 rounded-lg hover:bg-purple-800 transition"
//           >
//             Read More →
//           </Link>
//         </div>
